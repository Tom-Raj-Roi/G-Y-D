...
const SOCIALS: { id: string; label: string; fallback: string; Icon: React.ComponentType<{ className?: string }> }[] = [
  { id: "footer.social.whatsapp_channel", label: "WhatsApp Channel", fallback: "https://whatsapp.com/channel/your-channel", Icon: MessageCircle },
  { id: "footer.social.whatsapp_group", label: "WhatsApp Group", fallback: "https://chat.whatsapp.com/your-group", Icon: Users },
  { id: "footer.social.telegram", label: "Telegram", fallback: "https://t.me/getyourdreams", Icon: Send },
  { id: "footer.social.instagram", label: "Instagram", fallback: "https://instagram.com/getyourdreams", Icon: Instagram },
  { id: "footer.social.tiktok", label: "TikTok", fallback: "https://tiktok.com/@getyourdreams", Icon: Music2 },
  { id: "footer.social.facebook", label: "Facebook", fallback: "https://facebook.com/getyourdreams", Icon: Facebook },
  { id: "footer.social.twitter", label: "Twitter / X", fallback: "https://x.com/getyourdreams", Icon: Twitter },
  { id: "footer.social.linkedin", label: "LinkedIn", fallback: "https://linkedin.com/company/getyourdreams", Icon: Linkedin },
];
    ...
    <footer className="bg-primary text-primary-foreground mt-20">
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/80">
            <li className="flex items-start gap-2">
              ...
              <div>
                <EditableText id="footer.phone1" fallback="+966 55 239 0860" /><br />
                <EditableText id="footer.phone2" fallback="+91 6374 504 413" /><br />
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/terms" onClick={scrollToTop} className="hover:text-accent transition-smooth">{translate("footer.terms")}</Link></li>
            <li><Link to="/privacy" onClick={scrollToTop} className="hover:text-accent transition-smooth">{translate("footer.privacy")}</Link></li>
